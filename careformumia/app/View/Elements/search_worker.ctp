<!-- File: /app/View/Elements/add_worker.ctp -->
	...
	<div class="expand" id="search-worker"><span class="sign">+</span> 檢索陪月員</div>
	<div class="expandable" id="search-worker-content">
	<?php echo $this->Form->create('Search', array('url' => array('controller' => 'workers', 'action' => 'search')));?> 
	<table class = "input">
	<th>個人信息</th>
	<tr><td>
	...
	<th>其他信息</th>	
	<tr><td>
	<?php echo $this->Form->input('date_of_birth', array('label' => '出生日期', 'type' => 'date','dateFormat' => 'YMD', 'minYear' => date('Y')-100, 'maxYear' => date('Y'), 'empty' => true, 'between' => '</td><td>'));?>
	</td><td>	
	<?php echo $this->Form->input('mariage_status', array('label' => '婚姻狀況', 'options' => array('unlimited' => '不限', 'S' => '單身', 'M' => '已婚', 'D' => '離婚', 'W' => '喪偶'), 'between' => '</td><td>'));?>
	</td><td>	
	<tr><td>	
	...
	<tr><td>
	<?php echo $this->Form->input('comments', array('label' => '評語', 'type' => 'textarea', 'row' => '3', 'between' => '</td><td colspan = "2">'));?>
	</td></tr>	
	<tr><td colspan = "5">
	...
	<table class = "input">
	<tr><td>	
	<?php echo $this->Form->input('year_exp', array('label' => '年資', 'type' => 'number', 'min' => '0', 'between' => '</td><td>'));?>
	</td><td>	
	<?php echo $this->Form->input('status', array('label' => '狀況', 'options' => array('unlimited' => '不限', 'A' => '活躍', 'IA' => '不活躍'), 'between' => '</td><td>'));?>
	</td></tr>
	</table>
	</td></tr>
	</table>
