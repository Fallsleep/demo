<!-- File: /app/View/Elements/add_asset.ctp -->

<?php 
$districts = $this->requestAction('Districts/index'); 
?>
<div class="expand" id="new-asset"><span class="sign">+</span> 新增資料</div>
<div class="expandable" id="new-asset-content">
	<?php echo $this->Form->create('Asset', array('url' => array('controller' => 'assets', 'action' => 'add'), 'type' => 'file')); ?>
	<table class = "input">
	<th>地產信息</th>
	<tr><td>	
	...
	<tr><td>
    <?php echo $this->Form->input('start_price', array('label' => '開盤價格',  'default' => '1', 'type' => 'text', 'between' => '</td><td>'));?>
	</td><td>
